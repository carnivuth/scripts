...
-- resize windows
hl.bind("SUPER + CTRL + L", hl.dsp.window.resize({x = step, y = 0, relative = true}))
hl.bind("SUPER + CTRL + H", hl.dsp.window.resize({x =-step, y = 0, relative = true}))
hl.bind("SUPER + CTRL + K", hl.dsp.window.resize({x = 0, y = -step, relative = true}))
hl.bind("SUPER + CTRL + J", hl.dsp.window.resize({x = 0, y= step, relative = true}))
