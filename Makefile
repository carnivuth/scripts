...
DEPS= hyprland hyprshot hyprpicker hyprpolkitagent hyprlock hypridle hyprpaper xdg-desktop-portal-hyprland dosfstools discord gamemode mangohud udiskie bash-completion wol parallel inotify-tools wireshark-cli fastfetch nextcloud-client pinentry-bemenu btop cliphist which starship rsync stow ffmpeg gawk wf-recorder calc tmux fzf lazygit network-manager-applet playerctl pamixer gnome-themes-extra jq bluez-utils ttf-dejavu mpv ranger thunderbird adwaita-icon-theme libnotify pop-icon-theme pavucontrol firefox telegram-desktop papirus-icon-theme brightnessctl mpv-mpris ttf-font-awesome github-cli socat blueman vim alacritty nm-connection-editor noto-fonts-emoji noto-fonts-cjk greetd greetd-tuigreet wev ttf-jetbrains-mono-nerd waybar bemenu-wayland bemenu-ncurses bemenu qt6-wayland wl-clipboard dunst curl retroarch upower libsecret
